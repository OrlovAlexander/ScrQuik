...
local logFile = nil
-- logFile = io.open(_G.getWorkingFolder().."\\LuaIndicators\\RPM_TF_Up_3.txt", "w")
...
local function Algo(Fsettings, ds)
    ...
    local midleDraw         = Fsettings.MidleDraw or 1
    local upDraw            = Fsettings.UpDraw or 1
    local upHistDraw        = Fsettings.UpHistDraw or 1
    ...
    return function (index)
        ...
        local status, res = pcall(function()
            ...
            if (fEmaMidle ~= nil and #midlePrice > 12 and midleDraw == 1) then
